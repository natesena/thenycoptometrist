      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        >
          ...
          <div className="relative p-8">
            ...
            >
               {/* @ts-expect-error: Type 'string[]' is not assignable to type 'JSX.Element[] */}
              {categories[activeCategory].optometrist.points.map((point, index) => (
                <motion.li
                  key={point}
        ...
        >
          ...
          <div className="relative p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900">Ophthalmologist</h3>
                <p className="text-purple-600 font-medium">
                   {/* @ts-expect-error: Type 'string[]' is not assignable to type 'JSX.Element[] */}
                  {categories[activeCategory].ophthalmologist.title}
                </p>
              </div>
            </div>
            ...
            >
              {/* @ts-expect-error: Type 'string[]' is not assignable to type 'JSX.Element[] */}
              {categories[activeCategory].ophthalmologist.points.map((point, index) => (
                <motion.li
                  key={point}
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
