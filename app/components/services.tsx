...
import { Eye, Baby, Droplet, Blend, PocketKnife, Contact, Search, CircleDot, Brain, AlertCircle, LucideAsteriskSquare, Moon, EyeIcon } from "lucide-react";
interface Service {
  id: string;
  title: string;
  icon: JSX.Element;
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <Contact className="w-6 h-6 transform rotate-45" />,
      description:
    ...
    },
    {
      ...
      icon: <LucideAsteriskSquare className="w-6 h-6" />,
      description:
          ...
          >
            ...
            >
              <div
                ...
                style={{ opacity: selectedService === service.id ? 0.1 : 0.1 }}
              />
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${service.color} text-slate-700`}>
                    {service.icon}
                  </div>
